...
Flow:
  ...
  2. Centralized Settings for Groq LLM + Embeddings (via app.llm)
...
import psycopg2
from app.ingestion.parser import LlamaParse
...
def run_ingestion_pipeline(
    ...
    1. Configure LlamaIndex globally (Groq LLM + Embeddings) — idempotent.
